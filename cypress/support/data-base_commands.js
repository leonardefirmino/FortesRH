...
Cypress.Commands.add("inserirSolicitacaoPessoal", () => {
    cy.exec_sql(
        "insert into cargo values (nextval('cargo_sequence'), 'Cargo Teste', 'Cargo Teste', null, null, null, null, null, null, null, null, null, (select id from empresa where nome = 'Empresa Padrão'), true, true, null, null)",
        "insert into faixasalarial values (nextval('faixasalarial_sequence'), 'Faixa_Nome', null, (select id from cargo where nome = 'Cargo Teste'), null, '252510')",
        ...
        "insert into cargo_areaorganizacional values ((select id from cargo where nome = 'Cargo Teste'), (select id from areaorganizacional where nome = 'Área Teste'))",
...
Cypress.Commands.add("insereSolicitacaoEmAnalise", () => {
    cy.exec_sql(
        ...
        "insert into solicitacao values (nextval('solicitacao_sequence'), '01/02/2020', null, 1, 'E', '02', 1000, null, null, 'I', null, false, false, null, (select id from motivosolicitacao where descricao = 'Aumento de Quadro'), (select id from areaorganizacional where nome = 'Área Teste'), 1, 1, null, (select id from empresa where nome = 'Empresa Padrão'), 1, 'Vaga para DEV', 1, 'Horário', 'I', null, null, null, null, '01/01/2020', false, null, null)",
    )
})
...
Cypress.Commands.add("insereCandidatoExterno", (candidato_nome) => {
    cy.exec_sql(
        ...
        "insert into candidatosolicitacao values (nextval('candidatosolicitacao_sequence'), true, (select id from candidato where nome = '" + candidato_nome + "'), 1, 'I', null, null, null, null)",
    )
})
...
Cypress.Commands.add("PesquisaLiberadaCom50Perguntas", () => {
    cy.exec_sql(
        "insert into questionario values (nextval('questionario_sequence'), 'Pesquisa Clima', null, '01/01/2021', '31/12/2021', true, false, false, 2, (select id from empresa where nome = 'Empresa Padrão'), false, false)",
        "insert into pesquisa values (nextval('pesquisa_sequence'), (select id from questionario where titulo = 'Pesquisa Clima'), false, false, false, false)",
    )
    var i = 1
    var num = 50
    do {
